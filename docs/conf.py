...
# -*- coding: utf-8 -*-
#
# syncer documentation build configuration file, created by
...
version = syncer.__version__
# The full version, including alpha/beta/rc tags.
release = syncer.__version__
...
html_theme_options = {
    ...
    'github_repo': 'syncer',
    'font_family': ', '.join(['"PT Serif"', font_family]),
    'head_font_family': ', '.join(['"PT Serif"',
                                   head_font_family,
                                   ]),
